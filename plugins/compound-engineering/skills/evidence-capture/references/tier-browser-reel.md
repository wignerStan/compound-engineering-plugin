...
```bash
bash scripts/capture-evidence.sh stitch [RUN_DIR]/demo.gif [RUN_DIR]/frame-*.png
```
...
```bash
bash scripts/capture-evidence.sh stitch --duration 2.0 [RUN_DIR]/demo.gif [RUN_DIR]/frame-*.png
```
